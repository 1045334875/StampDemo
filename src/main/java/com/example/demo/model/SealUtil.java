...
public abstract class SealUtil {
     ...
     * @throws Exception 异常
     */
    public static String buildAndStorePersonSeal(int imageSize, int lineSize, SealFont font, String addString
                                                 ) throws Exception {
     ...
     */
    public static String buildBytes(BufferedImage image) throws Exception {
